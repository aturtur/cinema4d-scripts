...
Name-US: AR_FindSource
Version: 1.0.1
Description-US: Selects the source object

Supports Instance, Connect, MoInstance, MoSpline, Cloner and Matrix objects

To Do:
    - Add support to X-Particle objects: emitter etc.
...
"""
1027133 # xpEmitter
xpEmitter[c4d.PARTICLES_EMITTER_SHAPE_OBJECT_LINK]
"""