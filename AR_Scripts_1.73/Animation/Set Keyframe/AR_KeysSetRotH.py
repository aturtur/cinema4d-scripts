...
Name-US: AR_KeysSetRotH
Version: 1.0.0
Description-US: Sets Rotation H(eading) keyframe for selected object(s) to current time with current value
...
def main():
    ...
    p = c4d.ID_BASEOBJECT_REL_ROTATION # Rotation
    a = c4d.VECTOR_X                   # X-axis
