...
Name-US: AR_PolySplit
Version: 1.0
Description-US: Splits the object into pieces by polygon selection tag(s).

Written for Maxon Cinema 4D R25.010
Python version 3.9.1

To Do:
- If polygon selection, split that selection to new object
- If object selection, split to polygon selections
- Key modifier -> delete from original
"""
