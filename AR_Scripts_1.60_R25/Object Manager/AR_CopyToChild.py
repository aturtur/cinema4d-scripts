...
Version: 1.0.1
Description-US: Creates a copy from object to the rest of the selected objects.

Default: copy from first selected.
Shift: copy from last selected.
Ctrl: Create instance instead of a copy.

Written for Maxon Cinema 4D R25.010
Python version 3.9.1

Change log:
1.0.1 (28.03.2022) - R25 support
"""
