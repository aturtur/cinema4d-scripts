...
def main():
    ...
    resizeComposition("Mid Center", new_w, new_h)
    ...
    trim_w = new_w - x2
    trim_h = new_h - y2
    resizeComposition("Top Left", new_w-trim_w, new_h-trim_h)
    ...
    resizeComposition("Bot Right", trim_w, trim_h) # Second trim top left
