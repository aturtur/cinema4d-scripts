"""
AR_TakeMarkToggleSelected

Author: Arttu Rautio (aturtur)
Website: http://aturtur.com/
Name-US: AR_TakeMarkToggleSelected
Version: 1.0.0
Description-US: Toggles mark on selected take(s)
...
def main():
    ...
    for take in takes: # Iterate through takes
        ...
        take[c4d.TAKEBASE_CHECK] = not take[c4d.TAKEBASE_CHECK] # Toggle mark
