...
Name-US: AR_KeysSetSclZ
Version: 1.0.0
Description-US: Sets Scale Z keyframe for selected object(s) to current time with current value
...
def main():
    ...
    p = c4d.ID_BASEOBJECT_REL_SCALE # Scale
