...
![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_Scripts.png "AR_Scripts")
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_AxisToCenter.png "AR_AxisToCenter") AR_AxisToCenter.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_BakeCameras.png "AR_BakeCameras") AR_BakeCameras.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_BakeObjectPLA.png "AR_BakeObjectPLA") AR_BakeObjectPLA.py
Bakes selected object(s) to point level animation (PLA) in world space. Preview range determines the baking range.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_BakeObjectPSR.png "AR_BakeObjectPSR") AR_BakeObjectPSR.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_BooleMuch.png "AR_BooleMuch") AR_BooleMuch.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_BooleSplit.png "AR_BooleSplit") AR_BooleSplit.py
Creates a boole setup from two selected objects that creates a piece effect.
**Shift:** Uses instances.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_ConsolidateMaterialTags.png "AR_ConsolidateMaterialTags") AR_ConsolidateMaterialTags.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_CopyTags.png "AR_CopyTags") AR_CopyTags.py
Copy selected tag(s) to selected object(s).

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_CopyToChild.png "AR_CopyToChild") AR_CopyToChild.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_CreateControlNulls.png "AR_CreateControlNulls") AR_CreateControlNulls.py
Create control null objects from selected point(s). Control nulls have frozen PSR by default.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_CreateFolderNull.png "AR_CreateFolderNull") AR_CreateFolderNull.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_CreateGuide.py.png "AR_CreateGuide.py") AR_CreateGuide.py.py
Creates a guide object from two selected objects or two selected points.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_CreateOwnMaterials.png "AR_CreateOwnMaterials") AR_CreateOwnMaterials.py
Creates (clones) own materials for selected object(s) from existing materials.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_CreateSpline.png "AR_CreateSpline") AR_CreateSpline.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_CreateStickyNulls.png "AR_CreateStickyNulls") AR_CreateStickyNulls.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_CreateVertexMap.png "AR_CreateVertexMap") AR_CreateVertexMap.py
**Default:** Creates a vertex map tag for selected object(s)
**Shift:** Creates a vertex map tag with linear field object.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_DistributeKeys.png "AR_DistributeKeys.py") AR_DistributeKeys.py
**Default:** Distributes selected keyframes evenly.
**Shift:** Give step (in frames) to distribute (user input).

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_DoomThisTagType.png "AR_DoomThisTagType") AR_DoomThisTagType.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_EaseCopy.png "AR_EaseCopy") AR_EaseCopy.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_EasePaste.png "AR_EasePaste") AR_EasePaste.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_ExportOBJs.png "AR_ExportOBJs") AR_ExportOBJs.py
Exports top level objects individually to OBJ file. Does not export animation.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_ExportSplineSeq.png "AR_ExportSplineSeq") AR_ExportSplineSeq.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_ImportImageFolder.png "AR_ImportImageFolder") AR_ImportImageFolder.py
**Default:** Import image folder to materials.
**Shift:** Generates image planes.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_ImportOBJFolder.png "AR_ImportOBJFolder") AR_ImportOBJFolder.py
Imports OBJ-files from selected folder to the active document.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_MergeSelectionTags.png "AR_MergeSelectionTags") AR_MergeSelectionTags
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_MoGraphSelectionTags.png "AR_MoGraphSelectionTags") AR_MoGraphSelectionTags
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_MoGraphSelectionTagsFromSelectedClones.png "AR_MoGraphSelectionTagsFromSelectedClones") AR_MoGraphSelectionTagsFromSelectedClones.py
Creates MoGraph Selection Tag for every single clone that are selected.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_MoGraphSelectionTagsRange.png "AR_MoGraphSelectionTagsRange") AR_MoGraphSelectionTagsRange.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_NodesAlignHorizontally.png "AR_NodesAlignHorizontally") AR_NodesAlignHorizontally.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_NodesAlignVertically.png "AR_NodesAlignVertically") AR_NodesAlignVertically.py
Aligns selected graph nodes vertically. Works in Xpresso graph and in Redshift material graph.
Xpresso tag or Redshift material has to be selected before running the script.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_NodesConnect.png "AR_NodesConnect") AR_NodesConnect.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_NodesDisconnect.png "AR_NodesDisconnect") AR_NodesDisconnect.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_NodesDistributeHorizontally.png "AR_NodesDistributeHorizontally") AR_NodesDistributeHorizontally.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_NodesDistributeVertically.png "AR_NodesDistributeVertically") AR_NodesDistributeVertically.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_NodesLineUpHorizontally.png "AR_NodesLineUpHorizontally") AR_NodesLineUpHorizontally.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_NodesLineUpVertically.png "AR_NodesLineUpVertically") AR_NodesLineUpVertically.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_NodesRSQuickMatte.png "AR_NodesRSQuickMatte") AR_NodesRSQuickMatte.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_NodesTextureControllers.png "AR_NodesTextureControllers") AR_NodesTextureControllers.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_ObjectToSpline.png "AR_ObjectToSpline") AR_ObjectToSpline.py
Converts selected object(s) to splines.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_OpenProjectFolder.png "AR_OpenProjectFolder") AR_OpenProjectFolder.py
Opens the folder in explorer where the project is saved.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_OpenRenderFolder.png "AR_OpenRenderFolder") AR_OpenRenderFolder.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_PixeurToMaterials.png "AR_PixeurToMaterials") AR_PixeurToMaterials.py
Create materials from Pixeur color palette file.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_PrintType.png "AR_PrintType") AR_PrintType.py
Prints selected object(s) type (ID). Utility script for helping for scripting.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_RandomColors.png "AR_RandomColors") AR_RandomColors.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_RandomizeOrder.png "AR_RandomizeOrder") AR_RandomizeOrder.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_ReferenceViewport.png "AR_ReferenceViewport") AR_ReferenceViewport.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_RemoveEmptySelectionTags.png "AR_RemoveEmptySelectionTags") AR_RemoveEmptySelectionTags.py
Removes empty selection tags from selected object(s) or if no selection all possible ones in the whole project.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_RemoveMissingTextureTags.png "AR_RemoveMissingTextureTags") AR_RemoveMissingTextureTags.py
**Default:** Removes texture tags that does not have assigned material.
**Shift:** Remove texture tags with missing selection tags.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_RemoveTags.png "AR_RemoveTags") AR_RemoveTags.py
Removes all tags. If object(s) selected removes tags only from selected object(s).

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_RemoveTextureTags.png "AR_RemoveTextureTags") AR_RemoveTextureTags.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_ReplaceObjects.png "AR_ReplaceObjects") AR_ReplaceObjects.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_ResizeCanvas.png "AR_ResizeCanvas") AR_ResizeCanvas.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectActiveCamera.png "AR_SelectActiveCamera") AR_SelectActiveCamera.py
Selects the active camera in the object manager.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectByVisibility.png "AR_SelectByVisibility") AR_SelectByVisibility.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectChildren.png "AR_SelectChildren") AR_SelectChildren.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectCousins.png "AR_SelectCousins") AR_SelectCousins.py
**Default:** Selects the object's Cousins.
**Ctrl:** Deselect original selection.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectDeepest.png "AR_SelectDeepest") AR_SelectDeepest.py
**Default:** Select children of selected object(s) that are the most deep in hierarchy.
**Shift:** Keep the original selection.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectDown.png "AR_SelectDown") AR_SelectDown.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectEffectors.png "AR_SelectEffectors") AR_SelectEffectors.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectEveryNth.png "AR_SelectEveryNth") AR_SelectEveryNth.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectGenerators.png "AR_SelectGenerators") AR_SelectGenerators.py
Selects MoGraph generator(s) that use(s) selected effector. Prints info also to console.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectNext.png "AR_SelectNext") AR_SelectNext.py
**Default:** Selects the next object(s).
**Shift:** Keeps the old selection.
**Ctrl:** Safe mode (keeps the last selected if next not found).

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectObject.png "AR_SelectObject") AR_SelectObject.py
**Default:** Select tag(s) object(s).
**Shift:** Keeps the old selection.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectPrev.png "AR_SelectPrev") AR_SelectPrev.py
**Default:** Selects the previous object(s).
**Ctrl:** Deselect original selection.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectRoots.png "AR_SelectRoots") AR_SelectRoots.py
**Default:** Selects the root object(s).
**Shift:** Keeps the old selection.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectSameColor.png "AR_SelectSameColor") AR_SelectSameColor.py
Selects object(s) with the same diplay color that the active object has.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectSiblings.png "AR_SelectSiblings") AR_SelectSiblings.py
**Default:** Selects the object's siblings.
**Shift:** Keeps the old selection.
**Ctrl:** Safe mode (keeps the last selected if next not found).

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectSourceObject.png "AR_SelectSourceObject") AR_SelectSourceObject.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectTags.png "AR_SelectTags") AR_SelectTags.py
**Default:** Select object(s) tag(s).
**Shift:** Keeps the old selection.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SelectUp.png "AR_SelectUp") AR_SelectUp.py
**Default:** Selects the parent object(s).
**Shift:** Keeps the old selection.
**Ctrl:** Safe mode (keeps the last selected if next not found).

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SequenceTracks.png "AR_SequenceTracks") AR_SequenceTracks.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SetMoGraphWeightMap.png "AR_SetMoGraphWeightMap") AR_SetMoGraphWeightMap.py
Sets current MoGraph weights to new MoGraph weight map tag.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_ShiftSelectedTag.png "AR_ShiftSelectedTag") AR_ShiftSelectedTag.py
**Default:** Shifts selected tag(s) one step to the right.
**Shift:** Shifts selected tag(s) one step to the left.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SplitByPolySelection.png "AR_SplitByPolySelection") AR_SplitByPolySelection.py
Splits object to individual objects by polygon selection tags.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_SwapObjects.png "AR_SwapObjects") AR_SwapObjects.py
**Default:** Swaps selected objects between each other.
**Shift:** Swaps also objects place in the hierarchy.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_TargetSniper_beta.png "AR_TargetSniper_beta") AR_TargetSniper_beta.py
Shoots ray from the selected camera(s) and cretes focus null to closest hitting point. Not recommended with heavy projects.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_ToggleEnable.png "AR_ToggleEnable") AR_ToggleEnable.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_ToggleGrid.png "AR_ToggleGrid") AR_ToggleGrid.py
Toggle grid visibility in viewport.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_ToggleTintedBorder.png "AR_ToggleTintedBorder") AR_ToggleTintedBorder.py
...
### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_VertexMapInvert.png "AR_VertexMapInvert") AR_VertexMapInvert.py
Inverts selected Vertex Map tag's data.

### ![alt text](https://raw.github.com/aturtur/c4d-scripts/img/AR_ViewportGradients.png "AR_ViewportGradients") AR_ViewportGradients.py
