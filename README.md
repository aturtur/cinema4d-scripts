...
### ![AR_AxisToCenter](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_AxisToCenter.tif) AR_AxisToCenter.py
...
### ![AR_BakeCameras](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_BakeCameras.tif) AR_BakeCameras.py
...
### ![AR_BakeObjectPLA](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_BakeObjectPLA.tif) AR_BakeObjectPLA.py
Bakes selected object(s) to point level animation (PLA) in world space. Preview range determines the baking range.

### ![AR_BakeObjectPSR](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_BakeObjectPSR.tif) AR_BakeObjectPSR.py
...
### ![AR_BooleMuch](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_BooleMuch.tif) AR_BooleMuch.py
...
### ![AR_BooleSplit](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_BooleSplit.tif) AR_BooleSplit.py
Creates a boole setup from two selected objects that creates a piece effect.
**Shift:** Uses instances.

### ![AR_ConsolidateMaterialTags](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_ConsolidateMaterialTags.tif) AR_ConsolidateMaterialTags.py
...
### ![AR_CopyTags](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_CopyTags.tif) AR_CopyTags.py
Copy selected tag(s) to selected object(s).

### ![AR_CopyToChild](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_CopyToChild.tif) AR_CopyToChild.py
...
### ![AR_CreateControlNulls](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_CreateControlNulls.tif) AR_CreateControlNulls.py
Create control null objects from selected point(s). Control nulls have frozen PSR by default.

### ![AR_CreateFolderNull](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_CreateFolderNull.tif) AR_CreateFolderNull.py
...
### ![AR_CreateGuide](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_CreateGuide.tif) AR_CreateGuide.py.py
Creates a guide object from two selected objects or two selected points.

### ![AR_CreateOwnMaterials](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_CreateOwnMaterials.tif) AR_CreateOwnMaterials.py
Creates (clones) own materials for selected object(s) from existing materials.

### ![AR_CreateSpline](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_CreateSpline.tif) AR_CreateSpline.py
...
### ![AR_CreateStickyNulls](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_CreateStickyNulls.tif) AR_CreateStickyNulls.py
...
### ![AR_CreateVertexMap](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_CreateVertexMap.tif) AR_CreateVertexMap.py
**Default:** Creates a vertex map tag for selected object(s)
**Shift:** Creates a vertex map tag with linear field object.

### ![AR_DistributeKeys.py](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_DistributeKeys.tif) AR_DistributeKeys.py
**Default:** Distributes selected keyframes evenly.
**Shift:** Give step (in frames) to distribute (user input).

### ![AR_DoomThisTagType](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_DoomThisTagType.tif) AR_DoomThisTagType.py
...
### ![AR_EaseCopy](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_EaseCopy.tif) AR_EaseCopy.py
...
### ![AR_EasePaste](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_EasePaste.tif) AR_EasePaste.py
...
### ![AR_ExportOBJs](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_ExportOBJs.tif) AR_ExportOBJs.py
Exports top level objects individually to OBJ file. Does not export animation.

### ![AR_ExportSplineSeq](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_ExportSplineSeq.tif) AR_ExportSplineSeq.py
...
### ![AR_ImportImageFolder](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_ImportImageFolder.tif) AR_ImportImageFolder.py
**Default:** Import image folder to materials.
**Shift:** Generates image planes.

### ![AR_ImportOBJFolder](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_ImportOBJFolder.tif) AR_ImportOBJFolder.py
Imports OBJ-files from selected folder to the active document.

### ![AR_MergeSelectionTags](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_MergeSelectionTags.tif) AR_MergeSelectionTags
...
### ![AR_MoGraphSelectionTags](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_MoGraphSelectionTags.tif) AR_MoGraphSelectionTags
...
### ![AR_MoGraphSelectionTagsFromSelectedClones](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_MoGraphSelectionTagsFromSelectedClones.tif) AR_MoGraphSelectionTagsFromSelectedClones.py
Creates MoGraph Selection Tag for every single clone that are selected.

### ![AR_MoGraphSelectionTagsRange](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_MoGraphSelectionTagsRange.tif ) AR_MoGraphSelectionTagsRange.py
...
### ![AR_NodesAlignHorizontally](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_NodesAlignHorizontally.tif) AR_NodesAlignHorizontally.py
...
### ![AR_NodesAlignVertically](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_NodesAlignVertically.tif) AR_NodesAlignVertically.py
Aligns selected graph nodes vertically. Works in Xpresso graph and in Redshift material graph.
Xpresso tag or Redshift material has to be selected before running the script.

### ![AR_NodesConnect](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_NodesConnect.tif) AR_NodesConnect.py
...
### ![AR_NodesDisconnect](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_NodesDisconnect.tif) AR_NodesDisconnect.py
...
### ![AR_NodesDistributeHorizontally](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_NodesDistributeHorizontally.tif) AR_NodesDistributeHorizontally.py
...
### ![AR_NodesDistributeVertically](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_NodesDistributeVertically.tif) AR_NodesDistributeVertically.py
...
### ![AR_NodesLineUpHorizontally](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_NodesLineUpHorizontally.tif) AR_NodesLineUpHorizontally.py
...
### ![AR_NodesLineUpVertically](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_NodesLineUpVertically.tif) AR_NodesLineUpVertically.py
...
### ![AR_NodesRSQuickMatte](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_NodesRSQuickMatte.tif) AR_NodesRSQuickMatte.py
...
### ![AR_NodesTextureControllers](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_NodesTextureControllers.tif) AR_NodesTextureControllers.py
...
### ![AR_ObjectToSpline](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_ObjectToSpline.tif) AR_ObjectToSpline.py
Converts selected object(s) to splines.

### ![AR_OpenProjectFolder](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_OpenProjectFolder.tif) AR_OpenProjectFolder.py
Opens the folder in explorer where the project is saved.

### ![AR_OpenRenderFolder](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_OpenRenderFolder.tif) AR_OpenRenderFolder.py
...
### ![AR_PixeurToMaterials](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_PixeurToMaterials.tif) AR_PixeurToMaterials.py
Create materials from Pixeur color palette file.

### ![AR_PrintType](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_PrintType.tif) AR_PrintType.py
Prints selected object(s) type (ID). Utility script for helping for scripting.

### ![AR_RandomColors](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_RandomColors.tif) AR_RandomColors.py
...
### ![AR_RandomizeOrder](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_RandomizeOrder.tif) AR_RandomizeOrder.py
...
### ![AR_ReferenceViewport](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_ReferenceViewport.tif) AR_ReferenceViewport.py
...
### ![AR_RemoveEmptySelectionTags](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_RemoveEmptySelectionTags.tif) AR_RemoveEmptySelectionTags.py
Removes empty selection tags from selected object(s) or if no selection all possible ones in the whole project.

### ![AR_RemoveMissingTextureTags](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_RemoveMissingTextureTags.tif) AR_RemoveMissingTextureTags.py
**Default:** Removes texture tags that does not have assigned material.
**Shift:** Remove texture tags with missing selection tags.

### ![AR_RemoveTags](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_RemoveTags.tif) AR_RemoveTags.py
Removes all tags. If object(s) selected removes tags only from selected object(s).

### ![AR_RemoveTextureTags](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_RemoveTextureTags.tif) AR_RemoveTextureTags.py
...
### ![AR_ReplaceObjects](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_ReplaceObjects.tif) AR_ReplaceObjects.py
...
### ![AR_ResizeCanvas](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_ResizeCanvas.tif) AR_ResizeCanvas.py
...
### ![AR_SelectActiveCamera](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectActiveCamera.tif) AR_SelectActiveCamera.py
Selects the active camera in the object manager.

### ![AR_SelectByVisibility](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectByVisibility.tif) AR_SelectByVisibility.py
...
### ![AR_SelectChildren](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectChildren.tif) AR_SelectChildren.py
...
### ![AR_SelectCousins](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectCousins.tif) AR_SelectCousins.py
**Default:** Selects the object's Cousins.
**Ctrl:** Deselect original selection.

### ![AR_SelectDeepest](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectDeepest.tif) AR_SelectDeepest.py
**Default:** Select children of selected object(s) that are the most deep in hierarchy.
**Shift:** Keep the original selection.

### ![AR_SelectDown](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectDown.tif) AR_SelectDown.py
...
### ![AR_SelectEffectors](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectEffectors.tif) AR_SelectEffectors.py
...
### ![AR_SelectEveryNth](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectEveryNth.tif) AR_SelectEveryNth.py
...
### ![AR_SelectGenerators](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectGenerators.tif) AR_SelectGenerators.py
Selects MoGraph generator(s) that use(s) selected effector. Prints info also to console.

### ![AR_SelectNext](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectNext.tif) AR_SelectNext.py
**Default:** Selects the next object(s).
**Shift:** Keeps the old selection.
**Ctrl:** Safe mode (keeps the last selected if next not found).

### ![AR_SelectObject](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectObject.tif) AR_SelectObject.py
**Default:** Select tag(s) object(s).
**Shift:** Keeps the old selection.

### ![AR_SelectPrev](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectPrev.tif) AR_SelectPrev.py
**Default:** Selects the previous object(s).
**Ctrl:** Deselect original selection.

### ![AR_SelectRoots](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectRoots.tif) AR_SelectRoots.py
**Default:** Selects the root object(s).
**Shift:** Keeps the old selection.

### ![AR_SelectSameColor](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectSameColor.tif) AR_SelectSameColor.py
Selects object(s) with the same diplay color that the active object has.

### ![AR_SelectSiblings](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectSiblings.tif) AR_SelectSiblings.py
**Default:** Selects the object's siblings.
**Shift:** Keeps the old selection.
**Ctrl:** Safe mode (keeps the last selected if next not found).

### ![AR_SelectSourceObject](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectSourceObject.tif) AR_SelectSourceObject.py
...
### ![AR_SelectTags](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectTags.tif) AR_SelectTags.py
**Default:** Select object(s) tag(s).
**Shift:** Keeps the old selection.

### ![AR_SelectUp](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SelectUp.tif) AR_SelectUp.py
**Default:** Selects the parent object(s).
**Shift:** Keeps the old selection.
**Ctrl:** Safe mode (keeps the last selected if next not found).

### ![AR_SequenceTracks](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SequenceTracks.tif) AR_SequenceTracks.py
...
### ![AR_SetMoGraphWeightMap](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SetMoGraphWeightMap.tif) AR_SetMoGraphWeightMap.py
Sets current MoGraph weights to new MoGraph weight map tag.

### ![AR_ShiftSelectedTag](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_ShiftSelectedTag.tif) AR_ShiftSelectedTag.py
**Default:** Shifts selected tag(s) one step to the right.
**Shift:** Shifts selected tag(s) one step to the left.

### ![AR_SplitByPolySelection](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SplitByPolySelection.tif) AR_SplitByPolySelection.py
Splits object to individual objects by polygon selection tags.

### ![AR_SwapObjects](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_SwapObjects.tif) AR_SwapObjects.py
**Default:** Swaps selected objects between each other.
**Shift:** Swaps also objects place in the hierarchy.

### ![AR_TargetSniper_beta](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_TargetSniper_beta.tif) AR_TargetSniper_beta.py
Shoots ray from the selected camera(s) and cretes focus null to closest hitting point. Not recommended with heavy projects.

### ![AR_ToggleEnable](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_ToggleEnable.tif) AR_ToggleEnable.py
...
### ![AR_ToggleGrid](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_ToggleGrid.tif) AR_ToggleGrid.py
Toggle grid visibility in viewport.

### ![AR_ToggleTintedBorder](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_ToggleTintedBorder.tif) AR_ToggleTintedBorder.py
...
### ![AR_VertexMapInvert](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_VertexMapInvert.tif) AR_VertexMapInvert.py
Inverts selected Vertex Map tag's data.

### ![AR_ViewportGradients](https://raw.githubusercontent.com/aturtur/cinema4d-scripts/master/img/AR_ViewportGradients.tif) AR_ViewportGradients.py
