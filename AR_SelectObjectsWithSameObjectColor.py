"""
AR_SelectObjectsWithSameObjectColor

Author: Arttu Rautio (aturtur)
Website: http://aturtur.com/
Name-US: AR_SelectObjectsWithSameObjectColor
Description-US: Selects objects with same object color that active object has.
